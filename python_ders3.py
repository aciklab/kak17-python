...
print("6. deneme alt alta bir şeyler\nyazmak gerekti sanki.\nhem de \"ilginç\" şekilde\nyazılar da yazabiliyoruz\n")
...
dosya1 = open("kak17_3p1.txt", "w")
print(veri1,"Deneme 1", file=dosya1)
dosya1.close()

dosya2 = open("kak17_3p2.txt", "w")
...
#dosya6 = open("kak17_dosya1.txt")
dosya6 = open("kak17_dosya1.txt","r")
print(dosya6.read())
dosya6.close()

# Alternatif
with open("kak17_dosya1.txt", "r") as dosya6:
	print(dosya6.read())
...
# Satır satır çeker
dosya7 = open("kak17_dosya1.txt","r")
# 1. satır
...
dosya8 = open("kak17_dosya1.txt","r")
print(dosya7.readline())
print(dosya7.readline())
print(dosya7.readline())
dosya8.seek(10)
...
dosya4 = open("kak17_dosya1.txt", "w")
dosya4.write("Bir şeyler yazalım")
dosya4.close()

# Ekleme Yapar
dosya5 = open("kak17_dosya1.txt", "a")
dosya5.write("Bir şeyler ekleyelim.")
dosya5.close()

# Alternatif
with open("kak17_dosya1.txt", "a") as dosya5:
	dosya5.write("Bir şeyler ekleyelim.")

# Dosyanın başına bir şey eklemek
with open("kak17_dosya1.txt", "r+") as dosya5:
	veri = dosya5.read()
	dosya5.seek(0)
